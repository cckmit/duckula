...
public interface CommonDeployMapper extends BaseMapper<CommonDeploy> {
	 ...
	 * @mbg.generated
	 */
	@Insert({ "insert into common_deploy (id, name, ", "deploy, env, namespace, ", "url, token, config, ",
			"host, pwd, user_id, ", "is_default, remark)", "values (#{id,jdbcType=BIGINT}, #{name,jdbcType=VARCHAR}, ",
			"#{deploy,jdbcType=VARCHAR}, #{env,jdbcType=VARCHAR}, #{namespace,jdbcType=VARCHAR}, ",
			"#{url,jdbcType=VARCHAR}, #{token,jdbcType=VARCHAR}, #{config,jdbcType=VARCHAR}, ",
			"#{host,jdbcType=VARCHAR}, #{pwd,jdbcType=VARCHAR}, #{userId,jdbcType=BIGINT}, ",
			"#{isDefault,jdbcType=VARCHAR}, #{remark,jdbcType=VARCHAR})" })
	 ...
	 * @mbg.generated
	 */
	@Select({ "select", "id, name, deploy, env, namespace, url, token, config, host, pwd, user_id, is_default, ",
			"remark", "from common_deploy", "where id = #{id,jdbcType=BIGINT}" })
	...
	@Update({ "update common_deploy", "set name = #{name,jdbcType=VARCHAR},", "deploy = #{deploy,jdbcType=VARCHAR},",
			...
			"is_default = #{isDefault,jdbcType=VARCHAR},", "remark = #{remark,jdbcType=VARCHAR}",

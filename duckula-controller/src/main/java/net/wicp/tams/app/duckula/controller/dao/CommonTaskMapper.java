...
public interface CommonTaskMapper extends BaseMapper<CommonTask> {
	 ...
	 * @mbg.generated
	 */
	@Insert({ "insert into common_task (id, name, ", "version, rule, deploy_id, ", "user_id, middleware_id, ",
			"instance_id)", "values (#{id,jdbcType=BIGINT}, #{name,jdbcType=VARCHAR}, ",
			"#{version,jdbcType=VARCHAR}, #{rule,jdbcType=VARCHAR}, #{deployId,jdbcType=BIGINT}, ",
			"#{userId,jdbcType=BIGINT}, #{middlewareId,jdbcType=BIGINT}, ", "#{instanceId,jdbcType=BIGINT})" })
	 ...
	 * @mbg.generated
	 */
	@Select({ "select", "id, name, version, rule, deploy_id, user_id, middleware_id, instance_id", "from common_task",
	...
	@Update({ "update common_task", "set name = #{name,jdbcType=VARCHAR},", "version = #{version,jdbcType=VARCHAR},",
			...
			"instance_id = #{instanceId,jdbcType=BIGINT}", "where id = #{id,jdbcType=BIGINT}" })

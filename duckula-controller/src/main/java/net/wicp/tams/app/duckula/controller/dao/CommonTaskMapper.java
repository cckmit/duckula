...
public interface CommonTaskMapper {
	 ...
	 * @mbg.generated
	 */
	@Delete({ "delete from common_task", "where id = #{id,jdbcType=INTEGER}" })
	 ...
	 * @mbg.generated
	 */
	@Insert({ "insert into common_task (id, name, ", "version, namespace, ", "rule)",
	 ...
	 * @mbg.generated
	 */
	@Select({ "select", "id, name, version, namespace, rule", "from common_task", "where id = #{id,jdbcType=INTEGER}" })

...
public interface CommonMiddlewareMapper {
    /**
     ...
     */
    @Insert({
        "insert into common_middleware (id, name, ",
        "middleware_type, version, ",
        "user_id, com_id, host, ",
        "port, port2, username, ",
        "password, hostsconfig, ",
        "opt, remark)",
    ...
    @Select({
        "select",
        "id, name, middleware_type, version, user_id, com_id, host, port, port2, username, ",
        "password, hostsconfig, opt, remark",
        "from common_middleware",
        "where id = #{id,jdbcType=BIGINT}"
    })
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("record") CommonMiddleware record, @Param("example") CommonMiddlewareExample example);

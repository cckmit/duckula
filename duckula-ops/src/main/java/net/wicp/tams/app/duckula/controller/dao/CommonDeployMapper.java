...
public interface CommonDeployMapper {
    /**
     ...
     */
    @Insert({
        "insert into common_deploy (id, name, ",
        "deploy, env, namespace, ",
        "url, token, user_id, ",
        "host, port, pwd_duckula, ",
        "hostsconfig, is_init, ",
        "is_default, imagegroup, ",
        "version, remark, ",
        "config)",
    ...
    @Select({
        "select",
        "id, name, deploy, env, namespace, url, token, user_id, host, port, pwd_duckula, ",
        "hostsconfig, is_init, is_default, imagegroup, version, remark, config",
        "from common_deploy",
        "where id = #{id,jdbcType=BIGINT}"
    })

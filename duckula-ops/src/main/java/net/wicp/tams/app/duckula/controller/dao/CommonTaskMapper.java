...
public interface CommonTaskMapper {
    ...
    @Insert({
        ...
        "version, buffer_type, ",
        "sendNum, rule, deploy_id, ",
        "user_id, middleware_id, ",
        "instance_id, group_id, ",
        "checkpoint, client_id, ",
        "ha_type, gtids, attr_config)",
    ...
    @Select({
        "select",
        "id, name, version, buffer_type, sendNum, rule, deploy_id, user_id, middleware_id, ",
        "instance_id, group_id, checkpoint, client_id, ha_type, gtids, attr_config",
        "from common_task",
        "where id = #{id,jdbcType=BIGINT}"
    })
    ...
    @Update({
        ...
        "set name = #{name,jdbcType=VARCHAR},",
          ...
          "buffer_type = #{bufferType,jdbcType=VARCHAR},",

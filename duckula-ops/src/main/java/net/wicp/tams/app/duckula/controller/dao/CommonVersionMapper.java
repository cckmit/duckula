...
public interface CommonVersionMapper extends BaseMapper<CommonVersion> {
	 ...
	 * @mbg.generated
	 */
	@Insert({ "insert into common_version (id, main_version, ", "main_path, data_version, ", "data_path, author, ",
			"update_time, readme)", "values (#{id,jdbcType=INTEGER}, #{mainVersion,jdbcType=VARCHAR}, ",
	 ...
	 * @mbg.generated
	 */
	@Select({ "select", "id, main_version, main_path, data_version, data_path, author, update_time, readme",
			"from common_version", "where id = #{id,jdbcType=INTEGER}" })
	...
	@Update({ "update common_version", "set main_version = #{mainVersion,jdbcType=VARCHAR},",
			...
			"data_path = #{dataPath,jdbcType=VARCHAR},", "author = #{author,jdbcType=VARCHAR},",

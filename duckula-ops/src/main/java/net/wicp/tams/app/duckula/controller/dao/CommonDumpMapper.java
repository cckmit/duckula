...
public interface CommonDumpMapper {
	 ...
	 * @mbg.generated
	 */
	@Insert({ "insert into common_dump (id, name, ", "version, namespace, ", "rule, deploy_id)",
			"values (#{id,jdbcType=BIGINT}, #{name,jdbcType=VARCHAR}, ",
			"#{version,jdbcType=VARCHAR}, #{namespace,jdbcType=VARCHAR}, ",
			"#{rule,jdbcType=VARCHAR}, #{deployId,jdbcType=BIGINT})" })
	 ...
	 * @mbg.generated
	 */
	@Select({ "select", "id, name, version, namespace, rule, deploy_id", "from common_dump",
	...
	@Update({ "update common_dump", "set name = #{name,jdbcType=VARCHAR},", "version = #{version,jdbcType=VARCHAR},",
			...
			"deploy_id = #{deployId,jdbcType=BIGINT}", "where id = #{id,jdbcType=BIGINT}" })

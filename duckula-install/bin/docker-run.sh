...
cd $DUCKULA3_HOME
echo "========================access folder======================================"
if [ ! -d "$DUCKULA3_DATA/logs/task/$1" ]; then
    mkdir -p $DUCKULA3_DATA/logs/task/$1
fi
...
LOG_ROOT="-DlogRoot=$DUCKULA3_DATA/logs/task/$1"
#jmxexport代理
...
#docker需要前端运行程序
java  ${JAVA_OPTS}  -jar $DUCKULA3_HOME/duckula-task.jar  $1
echo "========================serverice end======================================"